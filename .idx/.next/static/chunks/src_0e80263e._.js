...
_s(CartProvider, "kYdeP7ssaVcDCOjZfE7TcL0FZPo=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
function Header() {
    ...
    const { user, loading, isAdmin } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // Added isAdmin
...
_s(Header, "WtlryrmKcoKykf44uD0iLR4qyc8=", false, function() {
    return [
...
//# sourceMappingURL=src_0e80263e._.js.map